...
function PageNavCreate(id,props){
    ...
    if(this.pageCount<=this.perPageNum){
        this.pageNavUl.html("");
        $('<li class="page-nav-first" style="float: left;">'+
              '<a href="javascript:void(null)" aria-label="First page" pagenum="1" >'+
                '<span aria-hidden="true">&laquo;</span>'+
              '</a>'+
            '</li>'+
            '<li class="page-nav-prev" style="float: left;">'+
        ...
        for(var i =1; i<=this.pageCount; i++){
            $('<li class="pageNum" style="float: left;"><a href="javascript:void(null)"  pagenum="'+i+'" >'+i+'</a></li>').appendTo(this.pageNavUl);
            if(i == this.currentPage){
                this.pageNavUl.children("li.pageNum").last().addClass('active');
            }
        }

        $('<li class="page-nav-next" style="float: left;">'+
              ...
              '</a>'+
            '</li>'+
            '<li class="page-nav-last" style="float: left;">'+
        ...
        $('<li class="disabled" style="float: left;">'+
